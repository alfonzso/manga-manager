import { Context, Get, Post, Delete, HttpResponseOK, HttpResponseCreated, HttpResponseNotFound, HttpResponseNoContent } from '@foal/core';
...
export class ApiController {
  ...
  async getMangas() {
    ...
    return new HttpResponseOK(mangaList);
  }
